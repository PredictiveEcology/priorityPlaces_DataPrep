...
test_dir("C:/Users/tmichele/GitHub/priorityPlaces_DataPrep/priorityPlaces_DataPrep/priorityPlaces_DataPrep/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Users/tmichele/GitHub/priorityPlaces_DataPrep/priorityPlaces_DataPrep/priorityPlaces_DataPrep/tests/testthat/test-template.R")
