...
writeRaster(mySim$priorityAreas[["Year2100"]][["solution_1"]], file.path(Paths$outputPath, "priorityAreas_stream1_15_2100w.tif"), 
            format = "GTiff", overwrite = TRUE)
writeRaster(mySim$planningUnitsRaster, file.path(Paths$outputPath, "costBiodiversity_15105.tif"), format = "GTiff", overwrite = TRUE)
...
drive_upload(file.path(Paths$outputPath, "costBiodiversity_15105.tif"), as_id("18GOo_q0nIsKYxzhpHtCrrenFAXQRlv-D"))
