...
writeRaster(mySim$priorityAreas[["Year2100"]][["solution_1"]], file.path(Paths$outputPath, "priorityAreas_stream1_15_2100w.tif"), 
            format = "GTiff", overwrite = TRUE)
writeRaster(mySim$planningUnit[["Year2011"]], file.path(Paths$outputPath, "costBiodiversity_2011_15105.tif"), 
            format = "GTiff", overwrite = TRUE)
writeRaster(mySim$planningUnit[["Year2100"]], file.path(Paths$outputPath, "costBiodiversity_2100_15105.tif"), 
            format = "GTiff", overwrite = TRUE)
