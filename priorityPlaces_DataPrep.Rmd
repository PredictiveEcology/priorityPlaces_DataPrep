...
parameters <- list(
  priorityPlaces_DataPrep = list(
    ...
    "weights" = data.table(stream = c('stream3', 'stream4', 'stream5'),
...
mySim <- simInitAndSpades(times = times, params = parameters, modules = modules, objects = objects, loadOrder = unlist(modules))

writeRaster(mySim$priorityAreas[["Year2011"]][["solution_1"]], file.path(Paths$outputPath, "priorityAreas_stream1_15_2011w.tif"), 
            format = "GTiff", overwrite = TRUE)
writeRaster(mySim$priorityAreas[["Year2100"]][["solution_1"]], file.path(Paths$outputPath, "priorityAreas_stream1_15_2100w.tif"), 
            format = "GTiff", overwrite = TRUE)
writeRaster(mySim$priorityAreas[["Year2011"]][[1]], file.path(Paths$outputPath, "costBiodiversity_2011_15105.tif"), 
            format = "GTiff", overwrite = TRUE)
writeRaster(mySim$priorityAreas[["Year2100"]][[1]], file.path(Paths$outputPath, "costBiodiversity_2100_15105.tif"), 
            format = "GTiff", overwrite = TRUE)

drive_upload(file.path(Paths$outputPath, "priorityAreas_stream1_15_2011w.tif"), as_id("18GOo_q0nIsKYxzhpHtCrrenFAXQRlv-D"))
drive_upload(file.path(Paths$outputPath, "priorityAreas_stream1_15_2100w.tif"), as_id("18GOo_q0nIsKYxzhpHtCrrenFAXQRlv-D"))
drive_upload(file.path(Paths$outputPath, "costBiodiversity_2011_15105.tif"), as_id("18GOo_q0nIsKYxzhpHtCrrenFAXQRlv-D"))
drive_upload(file.path(Paths$outputPath, "costBiodiversity_2100_15105.tif"), as_id("18GOo_q0nIsKYxzhpHtCrrenFAXQRlv-D"))
...
mySim2 <- simInitAndSpades(times = times, params = parameters, modules = modules, objects = objects, loadOrder = unlist(modules))
writeRaster(mySim2$priorityAreas[["Year2011"]][[1]], file.path(Paths$outputPath, "priorityAreas_stream1_30w.tif"), 
            format = "GTiff", overwrite = TRUE)
writeRaster(mySim2$priorityAreas[["Year2100"]][[1]], file.path(Paths$outputPath, "priorityAreas_stream1_30w.tif"), 
            format = "GTiff", overwrite = TRUE)
drive_upload(file.path(Paths$outputPath, "priorityAreas_stream1_30_2011w.tif"), as_id("18GOo_q0nIsKYxzhpHtCrrenFAXQRlv-D"))
drive_upload(file.path(Paths$outputPath, "priorityAreas_stream1_30_2100w.tif"), as_id("18GOo_q0nIsKYxzhpHtCrrenFAXQRlv-D"))
...
mySim3 <- simInitAndSpades(times = times, params = parameters, modules = modules, objects = objects, loadOrder = unlist(modules))
writeRaster(mySim3$priorityAreas[["Year2011"]][[1]], file.path(Paths$outputPath, "priorityAreas_stream1_60_2011w.tif"), 
            format = "GTiff", overwrite = TRUE)
writeRaster(mySim3$priorityAreas[["Year2100"]][[1]], file.path(Paths$outputPath, "priorityAreas_stream1_60_2100w.tif"), 
            format = "GTiff", overwrite = TRUE)
drive_upload(file.path(Paths$outputPath, "priorityAreas_stream1_60_2011w.tif"), as_id("18GOo_q0nIsKYxzhpHtCrrenFAXQRlv-D"))
drive_upload(file.path(Paths$outputPath, "priorityAreas_stream1_60_2100w.tif"), as_id("18GOo_q0nIsKYxzhpHtCrrenFAXQRlv-D"))
