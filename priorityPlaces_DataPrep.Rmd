...
setPaths(modulePath = file.path(dirname(getwd())),
         inputPath = checkPath(file.path(scratchDir, "TMP_priorityPlacesTest", "inputs"), create = TRUE),
         outputPath = checkPath(file.path(scratchDir, "TMP_priorityPlacesTest", "outputs"), create = TRUE))
